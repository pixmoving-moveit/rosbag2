...
public:
  ...
  // The maximum duration of messages to hold in cache before being written to disk.
  // A value of 0 indicates that buffering will be limited by max_cache_size only.
